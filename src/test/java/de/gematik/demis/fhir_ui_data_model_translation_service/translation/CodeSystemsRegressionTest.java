...
class CodeSystemsRegressionTest {
  ...
  void shouldSortCodeSystemEntries() throws IOException {
    ...
    CodeSystems codeSystems =
        new CodeSystems(
            files, FhirContext.forR4Cached(), Collections.emptyList(), FEATURE_FLAGS_DISABLED);
    codeSystems.build();
