...
class FederalStatePathogenNotificationCategoryDataRegressionTest {
  ...
  void shouldCreateDataAndFillMapAndList() {
    ...
    FederalStateNotificationCategoryDataRegression federalStateNotificationCategoryDataRegression =
        new FederalStateNotificationCategoryDataRegression(
            snapshotFilesServiceMock, fhirContext, false, "", false, false);
    federalStateNotificationCategoryDataRegression.createData();

    assertThat(
            federalStateNotificationCategoryDataRegression.getFederalStateNotificationCategories())
        .isNotEmpty();
    assertThat(federalStateNotificationCategoryDataRegression.getFederalStates()).isNotEmpty();
    assertThat(
  ...
  void shouldMakeAllFederalStatesAvailable() {
    ...
    assertThat(federalStateNotificationCategoryDataRegression.getFederalStates())
        .isNotEmpty()
        .hasSize(16)
